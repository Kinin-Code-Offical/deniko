    ...
    switch (status) {
      case "SCHEDULED":
        return (
          ...
          >
            {dictionary.dashboard.student_detail.lessons.status.scheduled}
          </Badge>
        );
      case "COMPLETED":
        return (
          ...
          >
            {dictionary.dashboard.student_detail.lessons.status.completed}
          </Badge>
        );
      case "CANCELLED":
        return (
          ...
          >
            {dictionary.dashboard.student_detail.lessons.status.cancelled}
          </Badge>
        );
      case "MISSED":
        return (
          ...
          >
            {dictionary.dashboard.student_detail.lessons.status.missed}
          </Badge>
        );
      default:
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle>
          {dictionary.dashboard.student_detail.lessons.title}
        </CardTitle>
        <Button size="sm">
